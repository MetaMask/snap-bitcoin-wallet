// We keep these mappings separate as they rely on Address from `bitcoindevkit` that imports WASM
// and we don't want to import it in the whole package. DO NOT EXPORT IN index.ts
...
import type { Caip19Asset } from './mappings';
