...
export function esplorawallet_take_merged(a: number, b: number): Array;
export function __wbg_metamaskwallet_free(a: number, b: number): void;
export function metamaskwallet_from_descriptors(a: number, b: number, c: number, d: number, e: number, f: number, g: number): number;
export function metamaskwallet_from_mnemonic(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number): number;
export function metamaskwallet_from_xpriv(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number): number;
export function metamaskwallet_from_xpub(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number): number;
export function metamaskwallet_load(a: number, b: number): number;
export function metamaskwallet_full_scan(a: number, b: number, c: number): number;
export function metamaskwallet_sync(a: number, b: number): number;
export function metamaskwallet_network(a: number): number;
export function metamaskwallet_balance(a: number): number;
export function metamaskwallet_next_unused_address(a: number, b: number): number;
export function metamaskwallet_peek_address(a: number, b: number, c: number): number;
export function metamaskwallet_reveal_next_address(a: number, b: number): number;
export function metamaskwallet_reveal_addresses_to(a: number, b: number, c: number): Array;
export function metamaskwallet_list_unused_addresses(a: number, b: number): Array;
export function metamaskwallet_list_unspent(a: number): Array;
export function metamaskwallet_transactions(a: number): Array;
export function metamaskwallet_persist(a: number): number;
export function __wbg_wallet_free(a: number, b: number): void;
export function wallet_from_descriptors(a: number, b: number, c: number, d: number, e: number): Array;
export function wallet_from_mnemonic(a: number, b: number, c: number, d: number, e: number, f: number): Array;
export function wallet_from_xpriv(a: number, b: number, c: number, d: number, e: number, f: number): Array;
export function wallet_from_xpub(a: number, b: number, c: number, d: number, e: number, f: number): Array;
export function wallet_load(a: number): Array;
export function wallet_network(a: number): number;
export function wallet_balance(a: number): number;
export function wallet_next_unused_address(a: number, b: number): number;
export function wallet_peek_address(a: number, b: number, c: number): number;
export function wallet_reveal_next_address(a: number, b: number): number;
export function wallet_reveal_addresses_to(a: number, b: number, c: number): Array;
export function wallet_list_unused_addresses(a: number, b: number): Array;
export function wallet_list_unspent(a: number): Array;
export function wallet_transactions(a: number): Array;
export function wallet_take_staged(a: number): Array;
export function wallet_take_merged(a: number, b: number): Array;
...
export function closure760_externref_shim(a: number, b: number, c: number): void;
...
export function closure1241_externref_shim(a: number, b: number, c: number, d: number): void;
