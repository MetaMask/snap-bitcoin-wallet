...
- feat: add bufferToString ([#61](https://github.com/MetaMask/bitcoin/pull/61))
...
- chore: add commit method in state ([#32](https://github.com/MetaMask/bitcoin/pull/32))
...
- feat: support transactional in state manager ([#20](https://github.com/MetaMask/bitcoin/pull/20))
- feat: add permission validate on snap index ([#24](https://github.com/MetaMask/bitcoin/pull/24))
- fix: remove un use code in BaseSnapRpcHandler ([#19](https://github.com/MetaMask/bitcoin/pull/19))
- feat: add response struct ([#17](https://github.com/MetaMask/bitcoin/pull/17))
...
- feat: adding event emit before state store ([#13](https://github.com/MetaMask/bitcoin/pull/13))
