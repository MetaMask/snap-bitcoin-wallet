...
export function closure776_externref_shim(a: number, b: number, c: number): void;
...
export function closure1245_externref_shim(a: number, b: number, c: number, d: number): void;
